...
def init():
    ...
    try:
        ...
        popularDbEmprestimo(cursor, 1, 2, '02/04/2020 06:00', '02/04/2020 15:53')
        popularDbEmprestimo(cursor, 2, 3, '06/04/2020 07:00', '06/04/2020 10:00')
        popularDbEmprestimo(cursor, 3, 5, '15/04/2020 08:00', '15/04/2020 10:00')
        popularDbEmprestimo(cursor, 4, 4, '20/04/2020 09:00', '20/04/2020 15:00')
        popularDbEmprestimo(cursor, 5, 2, '02/05/2020 10:53', '02/05/2020 19:00')
