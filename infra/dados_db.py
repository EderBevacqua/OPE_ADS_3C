...
sql_create_tableUsuario = f"CREATE TABLE IF NOT EXISTS {table_usuario} (id INTEGER PRIMARY KEY AUTOINCREMENT, nome TEXT, numeroMatricula INTEGER UNIQUE, departamento TEXT, email TEXT, telefone INTEGER);"
...
def init():
    ...
    try:
        ...
        popularDbUsuario(cursor, 1, "ADMINISTRADOR", 1, 'TECNOLOGIA', 'admin@admin.com',119999999)
        popularDbUsuario(cursor, 2, "Jose",  222, 'Diretoria', 'diretor1@diretor.com',119999999)
        popularDbUsuario(cursor, 3, "Maria", 333, 'Eletronica', 'professor1@professor1.com', 118888888 )
        popularDbUsuario(cursor, 4, "Salomao", 444, 'Ciencias Espaciais', 'professor2@professor2.com', 1166666666)
        popularDbUsuario(cursor, 5, "Matheus", 555, 'Copa', 'copa@copa.com', 1166666666)
        ...
        popularDbEmprestimo(cursor, 3, 5, '2020-04-01 08:00', '2020-01-01 10:00')
        popularDbEmprestimo(cursor, 4, 4, '2020-04-20 09:00', '2020-04-20 15:00')
        popularDbEmprestimo(cursor, 5, 2, '2020-04-28 10:53', '2020-04-28 19:00')
